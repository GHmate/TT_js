...
var field_size = (site_orig_width)/(dimensions.x+1); //mezők mérete. ez lesz a mérvadó adat minden méretezésnél. ha változik ez alapján frissül minden
var border = {'x':field_size,'y':field_size}; //falak ennyivel beljebb kezdődjenek a saroktól
...
var path_gen_chance = 0.55; //útvonal generálási esély. célszerű 0.4 és 0.7 között tartani.
